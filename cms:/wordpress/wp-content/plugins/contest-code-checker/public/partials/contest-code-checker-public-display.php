...
$first_name_label = apply_filters("ccc_form_first_name_label_text", __("", "contest-code"));
$last_name_label = apply_filters("ccc_form_last_name_label_text", __("", "contest-code"));
$emailLabel = apply_filters("ccc_form_email_label_text", __("", "contest-code"));
$prizeCodeLabel = apply_filters("ccc_form_prize_code_label_text", __("", "contest-code"));
$submitPrizeLabel = apply_filters("ccc_form_submit_prize_label_text", __("Enter now", "contest-code"));
?>
<div id="contest_code_checker_container">
<img src="http://i.imgur.com/GeiqOXa.png" ></img>
...
<input type="text" name="contestants_name" placeholder="Surname + Family Name" id="contestants_name" required />
</p>

<p class="ccc_form_element">
<label for="contestants_email"><?php echo esc_html($emailLabel); ?></label>
<input type="text" name="contestants_email" placeholder="Email" id="contestants_email" />
</p>

<p class="ccc_form_element">
<label for="contestants_code"><?php echo esc_html($prizeCodeLabel); ?></label>
<input type="text" name="contestants_code" placeholder="Code" id="contestants_code" required />
</p>
